        ...
        <div class="container-fluid">
            <div class="row">
                <div class="card col-sm-6 border px-3 pb-3">
                    <div class="text-lg py-2">Edit employee</div>
                    @if(session('error'))
                    ...
                    <form action="{{ route('employees.update', $employee) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset($employee->photo ?? '300x300.png') }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('name') is-invalid @enderror"
                                   maxlength="256" value="{{ $employee->name }}" name="name" id="name">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('phone') is-invalid @enderror"
                                   value="{{ $employee->phone }}" name="phone" id="phone">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror"
                                   type="email" value="{{ $employee->email }}" name="email" id="email">
                            @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @foreach($positions as $position)
                                ...
                                @if($position->id == $employee->position_id) selected @endif>
                                    {{ $position->name }}
                                </option>
                            @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('salary') is-invalid @enderror"
                                   value="{{ $employee->salary }}" name="salary" id="salary">
                            @error('salary')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('head') is-invalid @enderror"
                                   value="{{ $employee->getHead()?->name }}" name="head" id="head">
                            @error('head')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" value="{{ $employee->employment_at }}" class="form-control datetimepicker-input
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-sm-6"><strong>
                                    Admin created ID : </strong> {{ $employee->admin_created_id }}
                            </div>
                        </div>
                        <div class="row pb-4">
                            <div class="col-sm-6"><strong>
                                    Updated at: </strong> {{ $employee->updated_at->format('d.m.y') }}
                            </div>
                            <div class="col-sm-6">
